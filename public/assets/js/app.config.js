(function(){
     ...
     * @type {Object}
     */
    const isAuthed = { isAuthed: ['auth', function isAuthed(auth) {
        return auth.assertAuthed();
    }]};
     ...
     * @type {Object}
     */
    const authListen = { authListen: ['$rootScope', '$location', function authListen($rootScope, $location) {

        var event = $rootScope.$on('$userAuthenticated', function() {
